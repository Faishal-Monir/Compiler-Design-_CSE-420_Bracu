...
%token IF ELSE FOR WHILE CONTINUE DO INT FLOAT VOID SWITCH DEFAULT GOTO BREAK CHAR DOUBLE RETURN CASE PRINTF ADDOP MULOP INCOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA COLON SEMICOLON ID CONST_INT CONST_FLOAT
